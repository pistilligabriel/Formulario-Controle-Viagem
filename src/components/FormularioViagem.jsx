...
export default function FormularioViagem() {
  ...
  useEffect(() => {
    axios
      .get(`https://sistema-transporte-api.sa-east-1.elasticbeanstalk.com/api/viagem/${id}`)
  ...
  const handleSubmit = async () => {
    try {
      ...
      await axios.post(
        `https://sistema-transporte-api.sa-east-1.elasticbeanstalk.com/api/viagem/${id}/checklist`,
        formData,
